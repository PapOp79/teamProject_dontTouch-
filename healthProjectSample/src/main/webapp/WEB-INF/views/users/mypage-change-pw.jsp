...
<ul class="nav nav-tabs nav-justified">
   <li class="nav-item" ><a class="nav-link active" href="<%=conPath %>/users/mypage-change-pw.jsp" style="font-size: 20px;"><strong>비밀번호 변경</strong></a></li>
   <li class="nav-item"><a class="nav-link" href="<%=conPath %>/users/mypage-user-update.jsp" style="font-size: 20px;"><strong>회원정보 수정</strong></a></li>
   <li class="nav-item"><a class="nav-link" href="<%=conPath %>/users/mypage-delete-check.jsp" style="font-size: 20px;"><strong>회원 탈퇴하기</strong></a></li>
   
</ul>
<br/><br/>

<h4 style="color: #ff52a0;">비밀번호 변경 페이지</h4><hr/><br/>
<form action="/izone/users/change-pw-controller.jsp" method="post" style="margin-bottom: 0;">
