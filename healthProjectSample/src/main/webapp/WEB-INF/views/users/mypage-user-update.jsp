...
<%@page import="com.jsp.izone.member.model.MemberVO"%>
	...
	<div class="col-md-6">
		...
		<ul class="nav nav-tabs nav-justified">
			<li class="nav-item"><a class="nav-link"
				href="/izone/users/mypage-change-pw.jsp" style="font-size: 20px;"><strong>비밀번호
						변경</strong></a></li>
			<li class="nav-item"><a class="nav-link active"
				href="/izone/users/mypage-user-update.jsp" style="font-size: 20px;"><strong>회원정보
						수정</strong></a></li>
			<li class="nav-item"><a class="nav-link"
				href="/izone/users/mypage-delete-check.jsp" style="font-size: 20px;"><strong>회원
						탈퇴하기</strong></a></li>
		...
		<hr />
		<br />
		<form action="/izone/users/user-update-controller.jsp" name="signup" id="signUpForm"
