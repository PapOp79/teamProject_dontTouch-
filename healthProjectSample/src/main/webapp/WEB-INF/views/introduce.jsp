...
<style>
header.masthead {
	background-image: url(resources/static/img/introduce/introduce.png);
}	
.intro-table {
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-hover">
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/keb.jpg">
          </a>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-hover">
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/sakura.jpg">
          </a>
          <div class="portfolio-caption">
            <h4>미야와키 사쿠라</h4>
            <p class="text-muted">서브보컬</p>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#KangHyeWon">   
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/khw.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>강혜원</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#ChoiYeNa">  
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/cyn.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>최예나</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#LeeChaeYeon"> 
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/lcy.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>이채연</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#KimChaeWon">     
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/kcw.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>김채원</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#KimMinJu"> 
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/kmj.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>김민주</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#nako">   
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/nako.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>야부키 나코</h4>
            <p class="text-muted">서브보컬</p>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#hitomi">
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/hitomi.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>혼다 히토미</h4>
            <p class="text-muted">서브보컬</p>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#ChoYuRi">  
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/jyr.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>조유리</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#AhnYuJin">
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/ayj.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>안유진</h4>
            <p class="text-muted">리드보컬</p>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#JangWonYoung"> 
            ...
            <img class="img-thumbnail img-fluid" src="resources/static/img/introduce/jwy.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>장원영</h4>
      ...
      <div class="modal-body">
        <div class="table-center">
        	<table class="intro-table">
        		<tr class="intro-tr">
        			<td colspan="2">
        				<img class="img-fluid" src="resources/static/img/introduce/keb_modal.jpg" alt="" width="100%">
        			</td>
        		</tr>
        		<tr class="intro-tr">
